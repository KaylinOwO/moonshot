...
void C_Hooks::Init()
{
	...
	{
		using namespace CLMainHook;

		CLMove::HookD.Init(gPattern.Find("engine.dll", "55 8B EC 83 EC 38 83 3D ? ? ? ? ?"), reinterpret_cast<void*>(CLMove::Hook));

		Util::PrintDebug("CLMove ready.\n");
	}
...
void C_Hooks::Release()
{
	...
	CLMainHook::CLMove::HookD.Shutdown();
