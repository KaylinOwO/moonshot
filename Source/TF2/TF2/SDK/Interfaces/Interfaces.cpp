...
void C_Interfaces::Init()
{
	...
	ModelRender = reinterpret_cast<CModelRender*>(gInterface.Get(ENGINE_DLL, VENGINE_MODELRENDER_INTERFACE));
	CHECKNULL(ModelRender, "ModelRender = nullptr!");

	MatSystem = reinterpret_cast<CMaterialSystem*>(gInterface.Get(MATSYSTEM_DLL, VMATERIALSYSTEM_INTERFACE));
