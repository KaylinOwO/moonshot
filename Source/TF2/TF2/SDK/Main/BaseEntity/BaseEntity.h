...
public:
	...
	bool IsBuilding()
	{
		return (this->GetClientClass()->iClassID == (int)ETFClassID::CObjectDispenser
			|| this->GetClientClass()->iClassID == (int)ETFClassID::CObjectSentrygun
			|| this->GetClientClass()->iClassID == (int)ETFClassID::CObjectTeleporter);
	}
};