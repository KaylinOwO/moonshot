...
#include "../../Features/Menu/Framework/Framework.h"
...
LONG __stdcall WndProcHook::Hook(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	if (GetAsyncKeyState(VK_MENU) && gFramework.b_mOpen && (gInput.m_Wheel == EScrollWheelState::DOWN || gInput.m_Wheel == EScrollWheelState::UP || gInput.m_LMouse == EKeyState::PRESSED || gInput.m_RMouse == EKeyState::PRESSED))
		return 1;
