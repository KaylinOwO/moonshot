...
struct ClientShadowHandle_t; struct RenderableInstance_t; struct ClientRenderHandle_t;
...
public:
	...
	virtual void					GetShadowRenderBounds(Vec3& mins, Vec3& maxs, void* shadowType) = 0;
	virtual bool					ShouldReceiveProjectedTextures(int flags) = 0;
	virtual bool					GetShadowCastDistance(float* pDist, void* shadowType) const = 0;
	virtual bool					GetShadowCastDirection(Vec3* pDirection, void* shadowType) const = 0;
...
public:
	...
	virtual C_ClientClass* GetClientClass() = 0;
...
struct FireBulletsInfo_t; struct SpatializationInfo_t; struct EmitSound_t;
class CTakeDamageInfo; class CCollisionProperty; class LineOfSightCheckType; class CSoundParameters;
class C_BaseEntity
{
public:
	...
	/*9*/	virtual Vec3& GetAbsOrigin(void)const = 0;
	/*10*/	virtual Vec3& GetAbsAngles(void)const = 0;
	/*11*/	virtual void* GetMouth(void) = 0;
	/*12*/	virtual void* GetSoundSpatialization(SpatializationInfo_t&) = 0;
	/*13*/	virtual C_ClientClass* GetClientClass(void) = 0;
	...
	/*20*/	virtual void* HandleShotImpactingWater(FireBulletsInfo_t const&, Vec3 const&, C_TraceFilter*, Vec3*) = 0;
	/*21*/	virtual void* GetBeamTraceFilter(void) = 0;
	/*22*/	virtual void* DispatchTraceAttack(CTakeDamageInfo const&, Vec3 const&, C_GameTrace*, void*) = 0;
	/*23*/	virtual void* TraceAttack(CTakeDamageInfo const&, Vec3 const&, C_GameTrace*, void*) = 0;
	/*24*/	virtual void* DoImpactEffect(C_GameTrace&, int) = 0;
	/*25*/	virtual void* MakeTracer(Vec3 const&, C_GameTrace const&, int) = 0;
	/*26*/	virtual void* GetTracerAttachment(void) = 0;
	/*30*/	virtual Color_t BloodColor(void) = 0;
	...
	/*192*/	virtual Vec3& EyeAngles(void) = 0;
	/*193*/	virtual Vec3& LocalEyeAngles(void) = 0;
	/*194*/	virtual Vec3 EarPosition(void) = 0;
	/*195*/	virtual bool ShouldCollide(int, int)const = 0;
	/*196*/	virtual Vec3& GetViewOffset(void) = 0;
	...
	/*324*/	virtual void* SetupGlobalWeights(matrix3x4 const*, int, float*, float*) = 0;
	/*325*/	virtual void* SetupLocalWeights(matrix3x4 const*, int, float*, float*) = 0;
	...
	/*335*/	virtual bool IsLookingTowards(Vec3 const&, float)const = 0;
	/*336*/	virtual bool IsInFieldOfView(C_BaseEntity*)const = 0;
	/*337*/	virtual bool IsInFieldOfView(Vec3 const&)const = 0;
	/*338*/	virtual bool IsLineOfSightClear(C_BaseEntity*, LineOfSightCheckType)const = 0;
	/*339*/	virtual bool IsLineOfSightClear(Vec3 const&, LineOfSightCheckType, C_BaseEntity*)const = 0;
	...
	/*346*/	virtual void* CalcView(Vec3&, Vec3&, float&, float&, float&) = 0;
	/*347*/	virtual void* CalcViewModelView(Vec3 const&, Vec3 const&) = 0;
	/*348*/	virtual void* CalcRoll(Vec3 const&, Vec3 const&, float, float) = 0;
	...
	/*352*/	virtual Vec3 GetAutoaimVector(float flDelta) = 0;
	/*353*/	virtual void* CreateMove(float, C_UserCmd*) = 0;
	/*354*/	virtual void* AvoidPhysicsProps(C_UserCmd*) = 0;
	...
	/*358*/	virtual C_BaseEntity* GetObserverTarget(void)const = 0;
	...
	/*388*/	virtual void* ViewPunch(Vec3 const& angleOffset) = 0;
	...
	/*397*/	virtual void* UpdateStepSound(void*, Vec3 const&, Vec3 const&) = 0;
	/*398*/	virtual void* PlayStepSound(Vec3&, void*, float, bool) = 0;
	/*399*/	virtual void* GetFootstepSurface(Vec3 const&, char const*) = 0;
	...
	/*403*/	virtual void* OnEmitFootstepSound(CSoundParameters const&, Vec3 const&, float) = 0;
	...
	/*409*/	virtual int CalcObserverView(Vec3&, Vec3&, float&) = 0;
	/*410*/	virtual void* GetChaseCamViewOffset(C_BaseEntity*) = 0;
	/*411*/	virtual void* CalcInEyeCamView(Vec3&, Vec3&, float&) = 0;
	/*412*/	virtual double GetDeathCamInterpolationTime(void) = 0;
	/*413*/	virtual float* CalcDeathCamView(Vec3&, Vec3&, float&) = 0;
	/*414*/	virtual void* CalcFreezeCamView(Vec3&, Vec3&, float&) = 0;
	/*415*/	virtual int SetLocalViewAngles(Vec3 const&) = 0;
	/*416*/	virtual int SetViewAngles(Vec3 const&) = 0;
...
//	Vec3 GetViewOffset();
	...
	Vec3 GetHitboxPos(const char* nHitbox, bool Uninterpolated = false);
...
//	model_t* GetModel();
	...
	{
		return *(studiohdr_t**)((uintptr_t)this + 0x16CC);
	}
};