...
public:
	...
	/*17*/	virtual C_ClientClass* GetClientClass(void) = 0;
	...
	/*23*/	virtual void* HandleShotImpactingWater(FireBulletsInfo_t const&, Vec3 const&, C_TraceFilter*, Vec3*) = 0;
	/*24*/	virtual void* GetBeamTraceFilter(void) = 0;
	/*25*/	virtual void* DispatchTraceAttack(CTakeDamageInfo const&, Vec3 const&, C_GameTrace*, void*) = 0;
	/*26*/	virtual void* TraceAttack(CTakeDamageInfo const&, Vec3 const&, C_GameTrace*, void*) = 0;
	/*27*/	virtual void* DoImpactEffect(C_GameTrace&, int) = 0;
	/*28*/	virtual void* MakeTracer(Vec3 const&, C_GameTrace const&, int) = 0;
	/*29*/	virtual void* GetTracerAttachment(void) = 0;
	/*30*/	virtual Color_t BloodColor_t(void) = 0;
	...
	/*39*/	virtual void* KeyValue(char const*, Vec3 const&) = 0;
	...
	/*66*/	virtual void* TestCollision(Ray_t const&, unsigned int, C_GameTrace&) = 0;
	/*67*/	virtual void* TestHitboxes(Ray_t const&, unsigned int, C_GameTrace&) = 0;
	...
	/*110*/	virtual void* ComputeWorldSpaceSurroundingBox(Vec3*, Vec3*) = 0;
	/*111*/	virtual void* GetSolid(void)const = 0;
	/*112*/	virtual void* GetSolidFlags(void)const = 0;
	/*115*/	virtual void* GetAttachment(int, Vec3&) = 0;
	/*117*/	virtual void* GetAttachmentVelocity(int, Vec3&, Quaternion&) = 0;
	...
	/*132*/	virtual void* GetAimEntOrigin(void*, Vec3*, Vec3*) = 0;
	...
	/*162*/	virtual void* AddDecal(Vec3 const&, Vec3 const&, Vec3 const&, int, int, bool, C_GameTrace&, int) = 0;
	...
	/*169*/	virtual void* DecalTrace(C_GameTrace*, char const*) = 0;
	/*170*/	virtual void* ImpactTrace(C_GameTrace*, int, char const*) = 0;
	...
	/*215*/	virtual void* PerformCustomPhysics(Vec3*, Vec3*, Vec3*, Vec3*) = 0;
	...
	/*242*/	virtual void* GetCustomisedRenderBounds(Vec3&, Vec3&) = 0;
	/*243*/	virtual void* SetCustomisedRenderBounds(Vec3*, Vec3*) = 0;
	...
	/*256*/	virtual void* StartDriving(C_BaseEntity*) = 0;
	/*257*/	virtual void* FinishDriving(C_BaseEntity*) = 0;
	...
	/*267*/	virtual void* BuildTransformations(void*, Vec3*, Quaternion*, matrix3x4 const&, int, void*, Vec3 const*) = 0;
	/*268*/	virtual void* ApplyBoneMatrixTransform(matrix3x4&) = 0;
	...
	/*276*/	virtual void* FireEvent(Vec3 const&, Vec3 const&, int, char const*) = 0;
	/*277*/	virtual void* FireObsoleteEvent(Vec3 const&, Vec3 const&, int, char const*) = 0;
	...
	/*281*/	virtual void* StandardBlendingRules(void*, Vec3*, Quaternion*, float, int) = 0;
	/*282*/	virtual void* AccumulateLayers(void*, Vec3*, Quaternion*, float) = 0;
	/*283*/	virtual void* ChildLayerBlend(Vec3*, Quaternion*, float, int) = 0;
	/*284*/	virtual void* AttachEntityToBone(void*, int, Vec3, Vec3) = 0;
	...
	/*289*/	virtual void* SaveRagdollInfo(int, matrix3x4 const&, void*) = 0;
	/*290*/	virtual void* RetrieveRagdollInfo(Vec3*, Quaternion*) = 0;
	/*291*/	virtual void* GetRagdollInitBoneArrays(matrix3x4*, matrix3x4*, matrix3x4*, float) = 0;
	...
	/*301*/	virtual void* UncorrectViewModelAttachment(Vec3&) = 0;
	...
	/*308*/	virtual void* FormatViewModelAttachment(int, matrix3x4&) = 0;
	...
	/*313*/	virtual void* SetOverrideViewTarget(Vec3) = 0;
	...
	/*326*/	virtual void* Drop(Vec3 const&) = 0;
	/*327*/	virtual void* UpdateClientData(C_BaseEntity*) = 0;
	...
	/*372*/	virtual void* CreateMove(float, C_UserCmd*, Vec3 const&) = 0;
	...
	/*387*/	virtual const Vec3& GetBulletSpread(void) = 0;
	/*388*/	virtual Vec3 GetBulletSpread(WeaponProficiency_t) = 0;
	/*389*/	virtual Vec3 GetSpreadBias(WeaponProficiency_t) = 0;
	...
	/*408*/	virtual void* AddViewmodelBob(void*, Vec3&, Vec3&) = 0;
	...
	/*456*/	virtual void* OnFireEvent(void*, Vec3 const&, Vec3 const&, int, char const*) = 0;
	...
	/*493*/	virtual void* GetTracerOrigin(Vec3&) = 0;
	...
	float GetTFAWeaponSpread()
	{
		auto pLua = gInts.LuaShared->GetLuaInterface(0);
		PushEntity(); //1

		pLua->GetField(-1, "CalculateConeRecoil"); 
		if (!pLua->IsType(-1, LuaObjectType::FUNCTION))
		{
			pLua->Pop(2);
			return -1;
		}
	...
	float GetPrimaryValue(const std::string& var)
	{
		auto pLua = gInts.LuaShared->GetLuaInterface(0);
		PushEntity();
		...
		pLua->GetField(-1, var.c_str());		
		auto r = (float)pLua->GetNumber(-1);
	...
	std::string GetWeaponBase()
	{
		auto pLua = gInts.LuaShared->GetLuaInterface(0);
		PushEntity(); 
		pLua->GetField(-1, "Base");
		if (!pLua->IsType(-1, LuaObjectType::STRING))
		{
			pLua->Pop(2);
			return "";
		}
		std::string out = pLua->GetString(-1);
		pLua->Pop(2);
		return out;
	}
	...
	Vec3 GetSpread()
	{
		...
		if (UsesLua())
		{
			auto LuaSpreadCone = GetPrimaryValue("Spread");
			if (GetWeaponBase().find("weapon_tttbase") != std::string::npos || GetWeaponBase().find("swb") != std::string::npos)
				LuaSpreadCone = GetPrimaryValue("Cone");

			if (LuaSpreadCone != 0.f)
				return { LuaSpreadCone };

			{
				...
				PushEntity();
				pLua->GetField(-1, "CurCone");
				if (pLua->IsType(-1, LuaObjectType::NUMBER))
					LuaSpreadCone = pLua->GetNumber();
			}
			...
			LuaSpreadCone = just_spread();
			if (LuaSpreadCone != -1.f)
				return { LuaSpreadCone };
		}
